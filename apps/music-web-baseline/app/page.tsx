...
const tracks: Track[] = [
  { title: "Je ne veux pas enfermer ton aujourd'hui", artist: "Cadeau10", length: "2:44", tag: "专辑 1", src: "/audio/cadeau10-album1/je-ne-veux-pas-enfermer-ton-aujourdhui.wav" },
  { title: "Ne vivons pas seulement de souvenirs", artist: "Cadeau10", length: "3:39", tag: "专辑 1", src: "/audio/cadeau10-album1/ne-vivons-pas-seulement-de-souvenirs.wav" },
  { title: "Nous pouvons nous reconnaître encore", artist: "Cadeau10", length: "2:59", tag: "专辑 1", src: "/audio/cadeau10-album1/nous-pouvons-nous-reconnaitre-encore.wav" },
  { title: "Où es-tu maintenant", artist: "Cadeau10", length: "3:04", tag: "专辑 1", src: "/audio/cadeau10-album1/ou-es-tu-maintenant.wav" },
  { title: "Vieillir et devenir nouveau avec toi", artist: "Cadeau10", length: "3:02", tag: "专辑 1", src: "/audio/cadeau10-album1/vieillir-et-devenir-nouveau-avec-toi.wav" },
];
